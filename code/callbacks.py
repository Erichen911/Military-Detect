...
class CustomModelCheckpoint(ModelCheckpoint):
    ...
    """
    def __init__(self, textedit,cure,loss,model_to_save, **kwargs):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        self.loss.append(logs.get(self.monitor))
        self.textedit.append("Epoch:"+str(len(self.loss))+"  "+str(self.loss[-1]))
        self.cure.setData(self.loss)
